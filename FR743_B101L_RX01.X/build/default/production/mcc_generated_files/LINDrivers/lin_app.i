...
# 58 "mcc_generated_files/LINDrivers/lin_app.c"
...
# 59 "mcc_generated_files/LINDrivers/lin_app.c" 2
...
void processLIN(void) {
    ...
    switch (cmd) {
        ...
        case SW_STATE:
            ...
            if ( (tempRxData[2] & 0B00000001) == 0B00000001) {
                do { LATBbits.LATB4 = 1; } while(0);
            } else {
                do { LATBbits.LATB4 = 0; } while(0);
            }

            if ( (tempRxData[1] & 0B00001000) == 0B00001000) {
