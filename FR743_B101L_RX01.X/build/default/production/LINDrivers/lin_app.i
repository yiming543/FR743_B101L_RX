...
# 2 "<built-in>" 2
# 1 "LINDrivers/lin_app.c" 2
# 41 "LINDrivers/lin_app.c"
# 1 "LINDrivers/lin_app.h" 1
# 45 "LINDrivers/lin_app.h"
...
# 42 "LINDrivers/lin_app.c" 2
# 1 "LINDrivers/../mcc_generated_files/pin_manager.h" 1
# 54 "LINDrivers/../mcc_generated_files/pin_manager.h"
...
# 55 "LINDrivers/../mcc_generated_files/pin_manager.h" 2
# 196 "LINDrivers/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 208 "LINDrivers/../mcc_generated_files/pin_manager.h"
void PIN_MANAGER_IOC(void);
# 43 "LINDrivers/lin_app.c" 2
# 129 "LINDrivers/lin_app.c"
void POS_ON(void) { do { LATBbits.LATB5 = 1; } while(0); }
void POS_OFF(void) { do { LATBbits.LATB5 = 0; } while(0); }
void DRL_ON(void) { do { LATBbits.LATB4 = 1; } while(0); }
void DRL_OFF(void) { do { LATBbits.LATB4 = 0; } while(0); }
void LOBEAM_ON(void) { do { LATBbits.LATB3 = 1; } while(0); }
void LOBEAM_OFF(void) { do { LATBbits.LATB3 = 0; } while(0); }
void HIBEAM_ON(void) { do { LATBbits.LATB2 = 1; } while(0); }
void HIBEAM_OFF(void) { do { LATBbits.LATB2 = 0; } while(0); }
void LEFT_ON(void) { do { LATBbits.LATB1 = 1; } while(0); }
void LEFT_OFF(void) { do { LATBbits.LATB1 = 0; } while(0); }
void RIGHT_ON(void) { do { LATBbits.LATB0 = 1; } while(0); }
void RIGHT_OFF(void) { do { LATBbits.LATB0 = 0; } while(0); }
